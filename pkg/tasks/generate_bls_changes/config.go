...
type Config struct {
	LimitPerSlot         int    `yaml:"limitPerSlot" json:"limitPerSlot" desc:"Maximum number of BLS change operations to generate per slot."`
	LimitTotal           int    `yaml:"limitTotal" json:"limitTotal" desc:"Total limit on the number of BLS change operations to generate."`
	...
	TargetAddress        string `yaml:"targetAddress" json:"targetAddress" desc:"Execution layer address to set as withdrawal credentials."`
