...
type Config struct {
	...
	BuilderExit          bool   `yaml:"builderExit" json:"builderExit" desc:"If true, generate builder exits instead of validator exits. Uses BUILDER_INDEX_FLAG in the validator index field."`
	SendToAllClients     bool   `yaml:"sendToAllClients" json:"sendToAllClients" desc:"If true, submit voluntary exits to all ready consensus clients in parallel instead of just one."`
