...
type Config struct {
	LimitPerSlot         int    `yaml:"limitPerSlot" json:"limitPerSlot" desc:"Maximum number of exit operations to generate per slot."`
	LimitTotal           int    `yaml:"limitTotal" json:"limitTotal" desc:"Total limit on the number of exit operations to generate."`
