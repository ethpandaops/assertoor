...
if kurtosis enclave inspect "$ENCLAVE_NAME" > /dev/null; then
  ...
  kurtosis run ~/github/kurtosis-tech/ethereum-package --enclave "$ENCLAVE_NAME" --args-file "${__dir}/kurtosis.devnet.config.yaml" --image-download always --non-blocking-tasks
